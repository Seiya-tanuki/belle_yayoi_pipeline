...
| Wave 3 | OCR worker decomposition | C3 | Implement: 1 | Consult launch-ready (C3 spec drafting) | Per-spec judge accept + wave regression |
...
| C3 | OCR worker state split spec | `gas/OcrWorkerParallel.js`, `tests/` | `temp/refactor_control/session_prompts/wave3_consult_C3.md` | `.spec/specs/T-20260206-CORE-C3-ocr-worker-state-split.md` | Consult prompt ready | 2026-02-06 | Launch C3 consult, then run `wave3_consult_gatekeeper.md` |
